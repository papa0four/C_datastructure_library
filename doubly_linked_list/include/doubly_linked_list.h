...
#ifndef DOUBLY_LINKED_LIST_SINGLY_LINKED_LIST_H
#define DOUBLY_LINKED_LIST_SINGLY_LINKED_LIST_H
...
typedef void (*print_f) (dll_t * dll);
...
typedef struct dll_node
{
    ...
    struct dll_node * prev;     // a pointer to the previous node in the list
    struct dll_node * next;     // a pointer to the next node in the list
} node_t;
 ...
 * @return - (struct sl_list *) ON SUCCESS: a pointer to the heap allocated singly linked list structure.
